...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-28 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-[#080808] to-[#0d0d0d]" />
        ...
        <div ref={ref} className="reveal">
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-2 space-y-5">
              {[
                { title: "Free SEO Analysis", desc: "A full technical and content consultation - $500 value, yours free." },
              ...
              <div className="pt-4 border-t border-gray-800">
                <a href="mailto:hello@onestepstronger.media" className="flex items-center gap-2 text-gray-400 hover:text-orange-400 transition-colors text-sm mb-2">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                  </svg>
                  hello@onestepstronger.media
                </a>
                <a href="tel:+13125550100" className="flex items-center gap-2 text-gray-400 hover:text-orange-400 transition-colors text-sm">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 text-sm focus:outline-none focus:border-orange-500/50 transition-all"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#111] border border-white/10 rounded-lg px-4 py-3 text-gray-300 text-sm focus:outline-none focus:border-orange-500/50 transition-all"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 text-sm focus:outline-none focus:border-orange-500/50 transition-all resize-none"
                    />
                  </div>
