...
const socials = [
  {
    name: "Twitter / X",
    href: "#",
    icon: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />,
  },
  {
    name: "LinkedIn",
    href: "#",
...
export default function Footer() {
  return (
    <footer className="relative bg-[#050505] border-t border-white/5 pt-20 pb-8 overflow-hidden">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-orange-500/5 blur-[80px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          <div className="col-span-2 md:col-span-1">
            <a href="#" className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center font-black text-white text-sm shadow-lg shadow-orange-500/30">
                OS
              </div>
            ...
            <p className="text-gray-600 text-xs mb-5">Chicago, IL · Serving the US</p>
            <div className="flex gap-3">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.name}
                  className="w-9 h-9 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center hover:border-orange-500/40 hover:bg-orange-500/10 transition-all duration-300 group"
                >
                  <svg className="w-4 h-4 fill-gray-400 group-hover:fill-orange-400 transition-colors" viewBox="0 0 24 24">
                    {s.icon}
                  </svg>
                </a>
              ))}
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} One Step Stronger Media LLC. All rights reserved. Chicago, IL.
          </p>
