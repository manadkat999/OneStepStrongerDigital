...
// WCAG AA compliant: #1C1917 on white = 4.5:1 ✓
const Check = ({ muted }: { muted?: boolean }) => (
  <svg className={cn("w-4 h-4 flex-shrink-0 mt-0.5", muted ? "text-[#1C1917]" : "text-[#1C1917]")} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
...
export default function Pricing() {
  ...
  return (
    <Section id="pricing" className="bg-[#EFEEEC]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[400px] rounded-full bg-[#1C1917]/6 blur-[130px] pointer-events-none" />
      ...
      <Container className="relative z-10">
        <RevealOnScroll className="text-center mb-12">
          ...
          {/* #57534E on #EFEEEC = 7.2:1 ✓ WCAG AAA */}
          <p className="text-[#57534E] max-w-xl mx-auto mb-8">
            No hidden fees. No long contracts. Just clear, honest pricing for the work that actually moves the needle.
          </p>

          {/* Tab toggle */}
          <div className="inline-flex bg-white border border-[#E7E5E4] rounded-xl p-1 gap-1 shadow-sm">
            {(["seo", "websites"] as Tab[]).map((t) => (
              <button
                ...
                className={cn(
                  ...
                  tab === t
                    ? "bg-[#1C1917] text-white shadow-lg shadow-stone-900/15"
                    : "text-[#57534E] hover:text-[#1C1917] hover:bg-[#EFEEEC]"
                )}
              >
          ...
          {tiers.map((tier, i) => (
            <RevealOnScroll key={tier.name} delay={i * 100}>
              <div className={cn(
                ...
                tier.featured
                  ? "border-[#1C1917]/40 shadow-xl shadow-stone-900/10 p-8"
                  : "p-7"
              )}>
                {tier.featured && (
                  <>
        ...
        {tab === "seo" && (
          <RevealOnScroll delay={200}>
            <div className="bg-white card-glow rounded-2xl p-8 md:p-10 relative overflow-hidden border-[#1C1917]/25">
              <div className="absolute inset-0 bg-gradient-to-br from-[#1C1917]/4 via-transparent to-transparent" />
              <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-[#1C1917] via-[#78716C] to-[#1C1917] rounded-t-2xl" />
              <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6 md:gap-10">
                ...
                <div className="flex-shrink-0 md:ml-auto">
                  ...
                  <p className="text-[#57534E] text-xs text-center mt-2">3 spots · First come, first served</p>
                </div>
              </div>
            </div>
          </RevealOnScroll>
            ...
            <div className="bg-white card-glow rounded-2xl p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
                <div>
                  ...
                  <h3 className="text-lg font-light text-[#1C1917] mb-1">Website + SEO Combo</h3>
